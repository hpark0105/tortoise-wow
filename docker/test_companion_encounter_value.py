"""BL-002: value-level runner for Companion/Encounter.h.

Compiles docker/test_companion_encounter_value.cpp with any available C++
...
SRC = os.path.join(REPO, "docker", "test_companion_encounter_value.cpp")
...
class CompanionEncounterValueTest(unittest.TestCase):
    def test_encounter_value_module(self):
